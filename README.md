...
| **17 (API 37)** | ✅ **Supported** (v2.0.0 — targetSdk/compileSdk 37 + libxposed API 102.0.0) |
...
| Android 17 | Supported (v2.0.0 — targetSdk/compileSdk 37, platform installed from preview channel in CI) |
